...
export const Threads: React.FC<ThreadsProps> = ({
  color = [0.0, 0.5, 1.0], // More vibrant blue
  amplitude = 4.0, // Much more movement
  distance = 2.0, // Better separation
  enableMouseInteraction = true, // Enabled by default
  className = '',
  style = {},
  ...rest
}) => {
  ...
  useEffect(() => {
    ...
    // Set canvas to be fully visible
    gl.canvas.style.opacity = '1';
    gl.canvas.style.filter = 'brightness(1.5) contrast(1.5)';
